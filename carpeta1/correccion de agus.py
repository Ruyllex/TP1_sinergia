...
def armar_lista_de_palabras(texto):
    ...
    for i in lista_palabras:
        if i.lower() not in lista_palabras_sin_repetir and i != '' and len(i) >= 5:
...
def elegir_palabra(diccionario, longitud_palabra_elegida_validada):
    ...
    if longitud_palabra_elegida_validada == "":
...
def contar_puntajes(aciertos, desaciertos):
    ...
    total_puntaje_de_palabra = aciertos * 10 + desaciertos * (-5)
    
    return total_puntaje_de_palabra
...
def validar_longitud_palabra(longitud_palabra_elegida):
    ...
    while not bandera :
        ...
        if longitud_palabra_elegida.isnumeric() and int(longitud_palabra_elegida) in range(5, 16):#en vez de 5 poner 6 y el 16 es la long max dentro del texto
            bandera = True
        elif longitud_palabra_elegida == "":
            bandera = True
        else:
            bandera = False
...
def contador_aciertos_desaciertos(es_acierto,lista_aciertos_desaciertos):
    ...
    aciertos = lista_aciertos_desaciertos[0]
